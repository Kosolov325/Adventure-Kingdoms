  ...
  ("game_receive_network_message", # called by the game whenever a custom network message is received, both clients and servers
   [(store_script_param, ":sender_player_id", 1),
    ...
    (try_begin), # section of events received by clients from the server
      ...
      (else_try),
        (eq, ":event_type", server_event_me_chat),
        (neg|str_is_empty, s0),
        (display_message, s0, 0x007000),
        (call_script, "script_chat_overlay_add_to_local_buffer", 0x007000),
          ...
          (try_begin),
              ...
              (try_for_agents, ":other_agent_id"), # check if the other players are close enough
               ...
               (try_begin),
                 ...
                 (assign, ":server_event", server_event_me_chat),
                 (str_clear, s23),
              ...
              (else_try),
               (multiplayer_send_2_int_to_player, ":other_player_id", server_event_script_message_set_color, 0xFFB6A37D),
               (multiplayer_send_string_to_player, ":other_player_id", ":server_event", "@Comando Inexistente"),
              (try_end),
             (try_end),
          (else_try),
