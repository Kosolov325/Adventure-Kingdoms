          ...
          (try_begin),  #commands start
           ...
           (assign, ":server_event", server_event_script_message),
            (try_begin),
             ...
             (else_try),
               (str_equals, s0, "@/meuid", 1),
               (player_get_unique_id, reg0, ":sender_player_id"),
               (multiplayer_send_int_to_player, ":sender_player_id", server_event_script_message_set_color, 0x008000),
             ...
             (else_try),
               ...
               (try_begin),
                ...
                (else_try),
                  (multiplayer_send_int_to_player, ":sender_player_id", server_event_script_message_set_color, 0xFF0000),
             ...
             (else_try),
               ...
               (assign, ":set_owner", 1),
             (else_try),
               (str_equals, s0, "@/tirardono"),
               (assign, ":local_check", 1),
               (assign, ":remove_owner", 1),
             (else_try),
               (str_equals, s0, "@/tirarcahves"),
               (assign, ":local_check", 1),
               (assign, ":remove_key", 1),
             (else_try),
               (multiplayer_send_int_to_player, ":sender_player_id", server_event_script_message_set_color, 0xFF0000),
             ...
             (else_try),
                ...
                (player_get_slot, ":target_id", ":sender_player_id", slot_player_door_key_id),
                (player_get_slot, ":target_key", ":sender_player_id", slot_player_door_key_target),
                (player_get_slot, ":target_target_key", ":target_id", slot_player_door_key),
             (else_try),
                (eq, ":set_owner", 1),
                (player_get_slot, ":target_id", ":sender_player_id", slot_player_door_key_id),
             (else_try),
             ...
             (try_end),
               ...
               (try_for_agents, ":other_agent_id"), # check if the other players are close enough
                ...
                (else_try), #set target only if the player is closer
                  (eq, ":set_target", 1),
                  (try_begin),
                   (this_or_next|player_get_unique_id, reg1, ":other_player_id"),
                   (str_equals, ":target_id", reg1, 1),
                ...
                (else_try),
                   ...
                   (try_begin),
                    (player_is_admin, ":sender_player_id"),
                    (player_set_slot, ":other_player_id", slot_player_door_key, ":target_key"),
                   (else_try),
                ...
                (else_try),
                    ...
                    (try_begin),
                      (player_is_admin, ":sender_player_id"),
                      (player_set_slot, ":other_player_id", slot_player_door_key, 0),
                    (else_try),
                      (player_slot_eq, ":sender_player_id", slot_player_door_key_owner, 1),
                      (player_slot_eq, ":sender_player_id", slot_player_door_key, ":target_key"),
                      (player_slot_eq, ":sender_player_id", slot_player_door_key, ":target_target_key"),
                      (player_set_slot, ":other_player_id", slot_player_door_key, 0),
                    (try_end),
                (else_try),
                   (eq, ":set_owner", 1),
                   ...
                   (this_or_next|player_get_unique_id, reg1, ":other_player_id"),
                   (str_equals, ":target_id", reg1, 1),
                   (player_set_slot, ":other_player_id", slot_player_door_key_owner, 1),
                (else_try),
                   (eq, ":remove_owner", 1),
                   (player_is_admin, ":sender_player_id"),
                   (this_or_next|player_get_unique_id, reg1, ":other_player_id"),
                   (str_equals, ":target_id", reg1, 1),
                   (player_set_slot, ":target_id", slot_player_door_key_owner, 0),
               (try_end),
              (try_end),
            #Commands  end
            (else_try),
  ...
  ("cf_agent_pick_lock", # server: calculate whether an agent picks a lock successfully, based on skill, tool, and random chance
   ...
   [(store_script_param, ":agent_id", 1), # must be valid
    ...
    (else_try),
      ...
      (assign, reg25, ":check_var"),
      (multiplayer_send_2_int_to_player, ":player_id", preset_message_fail_sound, server_event_script_message_set_color, 0xFF0000),
